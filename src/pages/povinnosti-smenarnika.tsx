...
import pageData from '../data/pages/povinnosti-smenarnika/povinnosti-smenarnika.json'
import Button from "../components/Layout/Button";
import Link from "next/link";
import { useTranslations } from "../hooks/useTranslations"
// @ts-ignore
import BottomPartCsMdx from "../data/pages/povinnosti-smenarnika/bottomPartCs.mdx"
// @ts-ignore
import BottomPartEnMdx from "../data/pages/povinnosti-smenarnika/bottomPartEn.mdx"
...
const ObligationsPage = () => {
    ...
    return (
        <DefaultLayout>
			<SEO
				title="Povinnosti směnárníka podle zákona č. 277/2013 Sb. – smenarny.legal"
