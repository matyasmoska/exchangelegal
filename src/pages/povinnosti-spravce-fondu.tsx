...
// @ts-ignore
import TopPartMdx from "../data/pages/povinnosti-spravce-fondu/topPart.mdx"
// @ts-ignore
import BottomPartMdx from "../data/pages/povinnosti-spravce-fondu/bottomPart.mdx"

const ObligationsPage = () => {
    return (
        <DefaultLayout>
			<SEO
				title="Povinnosti správce fondu – 15zisif.cz"
