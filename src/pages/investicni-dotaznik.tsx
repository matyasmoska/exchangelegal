...
import pageData from '../data/pages/investicni-dotaznik/investicni-dotaznik.json'
...
// @ts-ignore
import BottomPartCsMdx from "../data/pages/investicni-dotaznik/bottomPartCs.mdx"
// @ts-ignore
import BottomPartEnMdx from "../data/pages/investicni-dotaznik/bottomPartEn.mdx"
...
const ObligationsPage = () => {
	...
	useEffect(() => {
		servicesForm.setFieldValue('checked', servicesData.services.filter(({ id }) => id === 'investicni-dotaznik'))
	}, [])
    ...
    return (
        <DefaultLayout>
			<SEO
				title="15 ZISIF – Investiční dotazník – 15zisif.cz"
				...
				<div className="relative w-full">
					<div className="h-[385px]">
						<Image
							...
							className="absolute"
							priority
							src={'/images/priprava-kid-dle-narizeni-priips.jpg'}
						/>
						<div
							className={c(
