...
import pageData from '../data/pages/investicni-smlouva/investicni-smlouva.json'
...
// @ts-ignore
import BottomPartCsMdx from "../data/pages/investicni-smlouva/bottomPartCs.mdx"
// @ts-ignore
import BottomPartEnMdx from "../data/pages/investicni-smlouva/bottomPartEn.mdx"
...
const ObligationsPage = () => {
	...
	useEffect(() => {
		servicesForm.setFieldValue('checked', servicesData.services.filter(({ id }) => id === 'investicni-smlouva'))
	}, [])
	
    return (
        <DefaultLayout>
			<SEO
				title="15 ZISIF – investiční smlouva – 15zisif.cz"
				...
				<div className="relative w-full">
					<div className="h-[385px]">
						<Image
							...
							className="absolute"
							priority
							src={'/images/investicni-smlouva.jpg'}
						/>
						<div
							className={c(
