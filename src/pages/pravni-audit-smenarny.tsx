...
import pageData from '../data/pages/pravni-audit-smenarny/pravni-audit-smenarny.json'
...
// @ts-ignore
import BottomPartCsMdx from "../data/pages/pravni-audit-smenarny/bottomPartCs.mdx"
// @ts-ignore
import BottomPartEnMdx from "../data/pages/pravni-audit-smenarny/bottomPartEn.mdx"
...
const ObligationsPage = () => {
	...
	useEffect(() => {
		const selectedServices = servicesData.services.filter(({ id }) => id === 'pravni-audit-smenarny')
    ...
    return (
        <DefaultLayout>
			<SEO
				title={{ cs: "Právní audit směnárny – pravoprosmenarny.cz", en: "Legal audit of an exchange office – pravoprosmenarny.cz" }}
