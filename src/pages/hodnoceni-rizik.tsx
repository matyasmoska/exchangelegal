...
import pageData from '../data/pages/hodnoceni-rizik/hodnoceni-rizik.json'
...
// @ts-ignore
import TopPartMdx from "../data/pages/hodnoceni-rizik/topPart.mdx"
// @ts-ignore
import BottomPartMdx from "../data/pages/hodnoceni-rizik/bottomPart.mdx"
...
const ObligationsPage = () => {
	...
	useEffect(() => {
		servicesForm.setFieldValue('checked', servicesData.services.filter(({ id }) => id === 'hodnoceni-rizik'))
	}, [])

    return (
        <DefaultLayout>
			<SEO
				title="Hodnocení rizik AML – připravíme dle požadavků zákona 2022 | AML solutions"
