...
import pageData from '../data/pages/co-je-to-minifond/co-je-to-minifond.json'
import Button from "../components/Layout/Button";
import Link from "next/link";
// @ts-ignore
import TopPartMdx from "../data/pages/co-je-to-minifond/topPart.mdx"
// @ts-ignore
import BottomPartMdx from "../data/pages/co-je-to-minifond/bottomPart.mdx"

const ObligationsPage = () => {
    return (
        <DefaultLayout>
			<SEO
				title="Co je to minifond? – 15zisif.cz"
				...
				<div className="relative w-full">
					<div className="h-[385px]">
						<Image
							...
							className="absolute"
							priority
							src={'/images/co-je-to-minifond.jpg'}
						/>
						<div
							className={c(
