...
import pageData from '../data/pages/priprava-kid-dle-narizeni-priips/priprava-kid-dle-narizeni-priips.json'
...
// @ts-ignore
import BottomPartCsMdx from "../data/pages/priprava-kid-dle-narizeni-priips/bottomPartCs.mdx"
// @ts-ignore
import BottomPartEnMdx from "../data/pages/priprava-kid-dle-narizeni-priips/bottomPartEn.mdx"
...
const ObligationsPage = () => {
    ...
    return (
        <DefaultLayout>
			<SEO
				title="15 ZISIF – Příprava KID dle nařízení PRIIPs – 15zisif.cz"
