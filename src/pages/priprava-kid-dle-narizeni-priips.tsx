...
// @ts-ignore
import TopPartMdx from "../data/pages/priprava-kid-dle-narizeni-priips/topPart.mdx"
// @ts-ignore
import BottomPartMdx from "../data/pages/priprava-kid-dle-narizeni-priips/bottomPart.mdx"
