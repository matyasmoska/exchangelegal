...
// @ts-ignore
import BottomPartCsMdx from "../data/pages/zalozeni-alternativniho-fondu-na-klic/bottomPartCs.mdx"
// @ts-ignore
import BottomPartEnMdx from "../data/pages/zalozeni-alternativniho-fondu-na-klic/bottomPartEn.mdx"
...
const ObligationsPage = () => {
	...
	useEffect(() => {
		const selectedServices = servicesData.services.filter(({ id }) => id === 'zalozeni-alternativniho-fondu-na-klic')
