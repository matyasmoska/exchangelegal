...
import pageData from '../data/pages/reporting-cnb-pro-smenarny/reporting-cnb-pro-smenarny.json'
...
// @ts-ignore
import BottomPartCsMdx from "../data/pages/reporting-cnb-pro-smenarny/bottomPartCs.mdx"
// @ts-ignore
import BottomPartEnMdx from "../data/pages/reporting-cnb-pro-smenarny/bottomPartEn.mdx"
...
const ObligationsPage = () => {
	...
	useEffect(() => {
		const selectedServices = servicesData.services.filter(({ id }) => id === 'reporting-cnb')
    ...
    return (
        <DefaultLayout>
			<SEO
				title={{ cs: "Reporting ČNB pro směnárny – výkaz DEV 26-04 – pravoprosmenarny.cz", en: "CNB reporting for exchange offices – DEV 26-04 report – pravoprosmenarny.cz" }}
