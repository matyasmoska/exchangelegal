...
const ServiceFormSuccessPage = () => {
	...
	return (
		<DefaultLayout>
			<SEO
				title={{ cs: "Děkujeme za Vaši objednávku! pravoprosmenarny.cz", en: "Thank you for your order! pravoprosmenarny.cz" }}
				...
				keywords={{ cs: "směnárna, založení směnárny, povolení k činnosti směnárníka, ČNB, AML", en: "exchange office, bureau de change, CNB licence, AML, test purchase, currency exchange" }}
			/>
