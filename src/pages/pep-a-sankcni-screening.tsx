...
import pageData from '../data/pages/pep-a-sankcni-screening/pep-a-sankcni-screening.json'
...
// @ts-ignore
import TopPartCsMdx from "../data/pages/pep-a-sankcni-screening/topPartCs.mdx"
// @ts-ignore
import TopPartEnMdx from "../data/pages/pep-a-sankcni-screening/topPartEn.mdx"
// @ts-ignore
import BottomPartCsMdx from "../data/pages/pep-a-sankcni-screening/bottomPartCs.mdx"
// @ts-ignore
import BottomPartEnMdx from "../data/pages/pep-a-sankcni-screening/bottomPartEn.mdx"
...
const ObligationsPage = () => {
	...
	useEffect(() => {
		const selectedServices = servicesData.services.filter(({ id }) => id === 'pep-sankcni-screening')
    ...
    return (
        <DefaultLayout>
			<SEO
				title={{ cs: "PEP a sankční screening klientů směnárny – pravoprosmenarny.cz", en: "PEP and sanctions screening of customers – pravoprosmenarny.cz" }}
