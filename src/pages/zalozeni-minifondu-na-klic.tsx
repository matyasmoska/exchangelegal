...
import pageData from '../data/pages/povinnosti-spravce-fondu/zalozeni-minifondu-na-klic.json'
import Button from "../components/Layout/Button";
import Link from "next/link";
// @ts-ignore
import TopPartMdx from "../data/pages/zalozeni-minifondu-na-klic/topPart.mdx"
// @ts-ignore
				...
				<div className="relative w-full">
					<div className="h-[385px]">
						<Image
							...
							className="absolute"
							priority
							src={'/images/zalozeni-minifondu-na-klic.jpg'}
						/>
						<div
							className={c(
