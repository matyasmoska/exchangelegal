...
import pageData from '../data/pages/riskyCountriesList/index.json'
// @ts-ignore
import TopPartMdx from "../data/pages/riskyCountriesList/topPart.mdx"
// @ts-ignore
import BottomPartMdx from "../data/pages/riskyCountriesList/bottomPart.mdx"
import DefaultLayout from "../layouts/DefaultLayout";
import ParagraphOrMultiple from "../components/Layout/ParagraphOrMultiple";
import Link from "next/link";
import Button from "../components/Layout/Button";

const RiskyCountriesListPage = () => {
    return (
        <DefaultLayout>
...
export default RiskyCountriesListPage;