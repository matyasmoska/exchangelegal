...
import pageData from '../data/pages/priprava-na-kontrolu-cnb/priprava-na-kontrolu-cnb.json'
...
// @ts-ignore
import BottomPartCsMdx from "../data/pages/priprava-na-kontrolu-cnb/bottomPartCs.mdx"
// @ts-ignore
import BottomPartEnMdx from "../data/pages/priprava-na-kontrolu-cnb/bottomPartEn.mdx"
...
const ObligationsPage = () => {
	...
	useEffect(() => {
		const selectedServices = servicesData.services.filter(({ id }) => id === 'priprava-na-kontrolu-cnb')
    ...
    return (
        <DefaultLayout>
			<SEO
				title={{ cs: "Příprava na kontrolu ČNB – kontrolní směny – pravoprosmenarny.cz", en: "Preparing for a CNB inspection – test purchases – pravoprosmenarny.cz" }}
