...
import pageData from '../data/pages/whistleblowing-smernice/whistleblowing-smernice.json'
...
// @ts-ignore
import BottomPartCsMdx from "../data/pages/whistleblowing-smernice/bottomPartCs.mdx"
// @ts-ignore
import BottomPartEnMdx from "../data/pages/whistleblowing-smernice/bottomPartEn.mdx"
...
const ObligationsPage = () => {
	...
	useEffect(() => {
		const selectedServices = servicesData.services.filter(({ id }) => id === 'whistleblowing-smernice')
    ...
    return (
        <DefaultLayout>
			<SEO
				title={{ cs: "Whistleblowing směrnice pro směnárny – pravoprosmenarny.cz", en: "Whistleblowing policy for exchange offices – pravoprosmenarny.cz" }}
