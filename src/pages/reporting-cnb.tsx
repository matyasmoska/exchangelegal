...
import pageData from '../data/pages/reporting-cnb/reporting-cnb.json'
...
// @ts-ignore
import TopPartMdx from "../data/pages/reporting-cnb/topPart.mdx"
// @ts-ignore
import BottomPartMdx from "../data/pages/reporting-cnb/bottomPart.mdx"
...
const ObligationsPage = () => {
	...
	useEffect(() => {
		servicesForm.setFieldValue('checked', servicesData.services.filter(({ id }) => id === 'reporting-cnb'))
	}, [])
	
    return (
        <DefaultLayout>
			<SEO
				title="Reporting ČNB (výkaznictví SDAT – ROFOS 36 a 37) – 15zisif.cz"
