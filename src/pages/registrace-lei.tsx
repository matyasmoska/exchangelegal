...
import pageData from '../data/pages/registrace-lei/registrace-lei.json'
...
// @ts-ignore
import BottomPartCsMdx from "../data/pages/registrace-lei/bottomPartCs.mdx"
// @ts-ignore
import BottomPartEnMdx from "../data/pages/registrace-lei/bottomPartEn.mdx"
...
const ObligationsPage = () => {
	...
	useEffect(() => {
		servicesForm.setFieldValue('checked', servicesData.services.filter(({ id }) => id === 'registrace-lei'))
	}, [])
	
    return (
        <DefaultLayout>
			<SEO
				title="15 ZISIF – registrace LEI – 15zisif.cz"
