...
// @ts-ignore
import TopPartMdx from "../data/pages/co-je-to-alternativni-investicni-fond/topPart.mdx"
// @ts-ignore
import BottomPartMdx from "../data/pages/co-je-to-alternativni-investicni-fond/bottomPart.mdx"

const ObligationsPage = () => {
    return (
        <DefaultLayout>
			<SEO
				title="15 ZISIF – alternativní investiční fond – vše, co potřebujete vědět – 15zisif.cz"
				...
				<div className="relative w-full">
					<div className="h-[385px]">
						<Image
							...
							className="absolute"
							priority
							src={'/images/co-je-to-alternativni-investicni-fond.jpg'}
						/>
						<div
							className={c(
