...
Při poskytování svých služeb a zpřístupňovaní svého obsahu uživatelům webových stránek https://www.15zisif.cz (dále jen jako „**webové stránky**“) využíváme – Mgr. Matyáš Moska, advokát a Mgr. Jakub Pártl, LL.M., advokát (dále jen "**15zisif.cz**") síťové identifikátory, tzv. cookies, a to za účelem umožnění a zefektivnění používání webových stránek.
