...
Při poskytování svých služeb a zpřístupňovaní svého obsahu uživatelům webových stránek https://www.smenarny.legal (dále jen jako „**webové stránky**“) využíváme – MOSKA MURAD advokátní kancelář, s.r.o., se sídlem Na Dolinách 153/22, Podolí, 147 00 Praha 4, IČO: 220 96 973, zapsaná v obchodním rejstříku vedeném Městským soudem v Praze, spisová značka C 410891 (dále jen "**smenarny.legal**") síťové identifikátory, tzv. cookies, a to za účelem umožnění a zefektivnění používání webových stránek.
...
smenarny.legal používá cookies zejména k následujícím účelům:
...
Jak je již výše uvedeno, na našich webových stránkách se vyskytují rovněž cookies našich smluvních partnerů. Tyto cookies jsou spravovány třetími stranami a smenarny.legal nemá přístup ke čtení nebo zápisu těchto dat. Jedná se zejména o inzertní či reklamní systémy nebo analýzy návštěvnosti webových stránek.
...
Za účelem jejich uplatnění můžete smenarny.legal, jako správce osobních údajů, kontaktovat přímo na adrese:
...
Bližší informace o ochraně osobních údajů ze strany smenarny.legal naleznete v <Link href="/zasady-zpracovani-osobnich-udaju" passHref><a>Zásadách zpracování osobních údajů</a></Link>.
