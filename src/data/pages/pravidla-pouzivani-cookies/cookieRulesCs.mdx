...
Při poskytování svých služeb a zpřístupňovaní svého obsahu uživatelům webových stránek https://www.15zisif.cz (dále jen jako „**webové stránky**“) využíváme – MOSKA MURAD advokátní kancelář, s.r.o., se sídlem Na usedlosti 1837/10, Braník, 147 00 Praha 4, IČO: 220 96 973, zapsaná v obchodním rejstříku vedeném Městským soudem v Praze, spisová značka C 410891 (dále jen "**15zisif.cz**") síťové identifikátory, tzv. cookies, a to za účelem umožnění a zefektivnění používání webových stránek.
...
15zisif.cz používá cookies zejména k následujícím účelům:
...
Jak je již výše uvedeno, na našich webových stránkách se vyskytují rovněž cookies našich smluvních partnerů. Tyto cookies jsou spravovány třetími stranami a 15zisif.cz nemá přístup ke čtení nebo zápisu těchto dat. Jedná se zejména o inzertní či reklamní systémy nebo analýzy návštěvnosti webových stránek.
...
Za účelem jejich uplatnění můžete 15zisif.cz, jako správce osobních údajů, kontaktovat přímo na adrese:

MOSKA MURAD advokátní kancelář, s.r.o.<br/>
Na usedlosti 1837/10<br/>
147 00 Praha 4

Případně na e-mailové adrese: matyas@moskamurad.legal

Bližší informace o ochraně osobních údajů ze strany 15zisif.cz naleznete v <Link href="/zasady-zpracovani-osobnich-udaju" passHref><a>Zásadách zpracování osobních údajů</a></Link>.
