...
Systém vnitřních zásad je rozsáhlý soubor interních směrnic, postupů a jiných nástrojů (formuláře, seznamy osob a další), které jednoznačně stanovují přesné AML postupy a procesy pro Vaši společnost a Vaše zaměstnance. Jeho povinnou součástí je taktéž Hodnocení rizik.
...
Systém vnitřních zásad je nutno pravidelně aktualizovat a tyto změny oznamovat Finančnímu analytickému úřadu či České národní bance a taktéž o něm a o jeho změnách pravidelně provádět <a href="https://www.amlsolutions.cz/aml-skoleni-a-metodika">školení zaměstnanců a dalších osob</a>(spolupracujících), a to **nejméně jedenkrát v průběhu 12 kalendářních měsíců**.
...
- obsahovat předpřipravené formuláře pro klienty a zaměstnance (včetně variant v jazyce typického klienta),
- obsahovat postupy dle uznávaných standardů (seznam uznávaných standardů publikuje např. ČNB a FAÚ),
- být napsán co nejpřesněji a nejsrozumitelněji pro osoby, které ho budou používat (bez nejednoznačných právních formulací),
...
- specializované informace z oblasti standardů v boji proti praní špinavých peněz,
