...
**Nikoli, pro 100% zjištění statusu PEP Vám AML zákon postačovat nebude a budete muset postupovat i dle výše uvedeného Metodického pokynu FAÚ.**

Je to proto, že zákonná definice politicky exponované osoby dle § 5 ods. 4 AML zákona stanoví velmi obecnou definici a pouze **demonstrativní** nikoli taxativní (úplný) výčet veřejných funkcí, která zakládají status PEP.
