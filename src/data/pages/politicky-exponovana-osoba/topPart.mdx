...
Seznam konkrétních funkcí PEP, který je uvedený v příloze č. 1 Metodického pokynu FAÚ č. 7, obsahuje všechny veřejné funkce, které jsou v České republice považovány za významné a které zakládají status PEP (jedná se o taxativní výčet). Tento seznam je uveřejněn na <a href="https://www.financnianalytickyurad.cz/download/FileUploadComponent-1750233108/1602246025_cs_metodicky-pokyn-c-7-opatreni-vuci-pep-vnitrostatni-seznam-funkci-pep.pdf">webových stránkách FAÚ</a>.
